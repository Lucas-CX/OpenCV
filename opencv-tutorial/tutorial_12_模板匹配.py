...
def template_demo():
    tpl = cv.imread("C:/Users/lcx/Pictures/testimage/zlyhead.png")
...
src = cv.imread("C:/Users/lcx/Pictures/testimage/zly.jpg")  # 读入图片放进src中
cv.namedWindow("zly")  # 创建窗口
cv.imshow("zly", src)  # 将src图片放入该创建的窗口中
template_demo()
